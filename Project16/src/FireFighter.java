...
public class FireFighter implements ITaxPyer
{
	private double m_income = -1;
    private boolean m_donePayingTaxes = false;
    
    FireFighter(double income)
    {
    	SetIncome(income);
    }
	...
	public void PayTaxes(double taxRate) 
	{
		...
		if (m_donePayingTaxes == false)
		{
			...
			System.out.println("FireFighter is paying the following as tax: " + taxAmount);
	...
	public void FileTaxReturn() 
	{
		...
		{
			System.out.println("FireFighter is filling his tax return");
		}
